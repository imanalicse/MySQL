...
-- Dumping structure for table classicmodels.committees
...
-- Dumping data for table classicmodels.committees: ~4 rows (approximately)
...
-- Dumping structure for table classicmodels.members
...
-- Dumping data for table classicmodels.members: ~5 rows (approximately)
...
-- Dumping data for table classicmodels.orderdetails: ~3,012 rows (approximately)
...
-- Dumping data for table classicmodels.orders: ~421 rows (approximately)
...
-- Dumping data for table classicmodels.products: ~85 rows (approximately)
