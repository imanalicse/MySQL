...
SELECT currency FROM shared_s3v3_organisations WHERE id = (SELECT organisation_id FROM shared_s3v3_org_orders WHERE order_reference_code = 'R5M2B4-P30KT9-1723603470');