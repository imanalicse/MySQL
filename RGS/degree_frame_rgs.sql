...
#new query:
SELECT id FROM latrobe_d8765_product_options WHERE product_id = 19 AND `status` = 1 AND option_id IN (SELECT id FROM latrobe_d8765_options WHERE colour = 'Black');
SELECT id FROM latrobe_d8765_product_options WHERE product_id = 20 AND `status` = 1 AND option_id IN (SELECT id FROM latrobe_d8765_options WHERE colour = 'Black');
